...
3. **Observe** stores founder-supplied public discussions or bounded audience excerpts as a separate evidence class. One observation is never promoted into a trend or proof of demand.
...
6. **Approve** gives the founder an editable draft and explicit approve/skip decision. No public side effect exists in this stage.
7. **Learn** records an observed metric and exposes aggregated outcome memory to the next agent run.
